...
const STORAGE_PRESETS_KEY = 'perihelion.phase4.presets';
const STORAGE_ENTERED_KEY = 'perihelion.phase4.entered';
const STORAGE_ONBOARDING_KEY = 'perihelion.phase4.onboarding.dismissed';
...
export default function App() {
  ...
  return (
    <main className="app-shell phase4-shell">
      <header className="hero-header panel">
        <div>
          <h1>Perihelion Zodiac Calendar • Phase 4</h1>
          <p>
